...
export class ConfigureAppComponent implements OnInit {
  ...
  async clearAllData() {
    ...
    try {
      ...
      // Get a new random API server or PawVault will get stuck in offline mode
