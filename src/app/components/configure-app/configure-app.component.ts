...
export class ConfigureAppComponent implements OnInit {
  ...
  async clearAllData() {
    ...
    try {
      ...
      // Get a new random API server or Biome will get stuck in offline mode
